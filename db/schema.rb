...
ActiveRecord::Schema[7.1].define(version: 20_260_421_022_213) do
  ...
  create_table 'rankings', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[movie_id date], name: 'ranking_movie_id_date_unique', unique: true
  end
  ...
  create_table 'reservations', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[date schedule_id sheet_id], name: 'reservation_schedule_sheet_unique', unique: true
